...
/********************************** RCC **********************************/
#define HCC_RCC_BASE			0x40023800

#define HCC_RCC_PLLCFGR			*(hcc_reg32 *)(HCC_RCC_BASE+0x04)
	#define HCC_PLLQ_m	0xf
	#define HCC_PLLQ_s	24

#define HCC_RCC_AHB2ENR			*(hcc_reg32 *)(HCC_RCC_BASE+0x34)
	#define HCC_OTGFSEN_m	1u
	#define HCC_OTGFSEN_s	7

#define HCC_RCC_AHB1ENR			*(hcc_reg32 *)(HCC_RCC_BASE+0x30)
...
#define HCC_RCC_APB1ENR			*(hcc_reg32 *)(HCC_RCC_BASE+0x40)
...
#define HCC_RCC_AHB2RSTR		*(hcc_reg32 *)(HCC_RCC_BASE+0x14)
	#define HCC_OTGFSRST_m	1u
	#define HCC_OTGFSRST_s	7

#define HCC_RCC_APB2ENR		        *(hcc_reg32 *)(HCC_RCC_BASE+0x44)
	#define HCC_SYSCFGEN_m	1u
	#define HCC_SYSCFGEN_s	14  


/********************************** TIMERS (BASIC) **********************************/
#define HCC_TIM_1_BASE			0x40010000
...
#define HCC_TIM_8_BASE			0x40010400
...
#define HCC_TIM_ARR(n)			*(hcc_reg16 *)(HCC_TIM_##n##_BASE+0x2c)
 ...
 /* As the STM32F2xx series MCU has combined the AFIO part into GPIO part
 so we Mask this section. Garry Meng */
/********************************** AFIO **********************************/
/*  
...
*/
/********************************** GPIO **********************************/
#define HCC_GPIO_PORT_A_BASE	0x40020000
#define HCC_GPIO_PORT_B_BASE	0x40020400
#define HCC_GPIO_PORT_C_BASE	0x40020800
#define HCC_GPIO_PORT_D_BASE	0x40020C00
#define HCC_GPIO_PORT_E_BASE	0x40021000 
#define HCC_GPIO_PORT_F_BASE	0x40021400
#define HCC_GPIO_PORT_G_BASE	0x40021800
  
#define HCC_GPIO_MODER(p)               *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x00)
#define HCC_GPIO_OTYPER(p)              *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x04)
#define HCC_GPIO_OSPEEDR(p)             *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x08)
#define HCC_GPIO_PUPDR(p)               *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x0c)
#define HCC_GPIO_IDR(p)                 *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x10)
#define HCC_GPIO_ODR(p)                 *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x14)
#define HCC_GPIO_BSRR(p)                *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x18)
#define HCC_GPIO_LCKR(p)                *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x1c)
#define HCC_GPIO_AFRL(p)                *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x20)
#define HCC_GPIO_AFRH(p)                *(hcc_reg32 *)(HCC_GPIO_PORT_##p##_BASE+0x24)  
...
#define HCC_OTG_GCCFG			*(hcc_reg32 *)(HCC_OTG_FS_BASE+0x038)
	...
	#define HCC_PWRDWN_s	16
        ...
        #define HCC_NOVBUSSENS_m	1u
	#define HCC_NOVBUSSENS_s	21
